...
userRouter.post("/getAll", permit(["manageLabours"]), getAllUsersController);

userRouter.get("/get/:userId", permit(["manageLabours"]), getUserController);
...
userRouter.put("/picture", imageUploader, pictureController);
